<template>
    <div style="backgroundImage: url('/wenxuewang/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">阅微文学网站注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="作者姓名" class="input" v-if="tableName=='zuozhe'">
                            <el-input v-model="ruleForm.zuozheName" autocomplete="off" placeholder="作者姓名"  />
                        </el-form-item>
                        <el-form-item label="作者手机号" class="input" v-if="tableName=='zuozhe'">
                            <el-input v-model="ruleForm.zuozhePhone" autocomplete="off" placeholder="作者手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='zuozhe'">
                            <el-input v-model="ruleForm.zuozheEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.zuozheName)&& 'zuozhe'==this.tableName){
                                this.$message.error('作者姓名不能为空');
                                return
                            }
                             if('zuozhe' == this.tableName && this.ruleForm.zuozhePhone&&(!this.$validate.isMobile(this.ruleForm.zuozhePhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('zuozhe' == this.tableName && this.ruleForm.zuozheEmail&&(!this.$validate.isEmail(this.ruleForm.zuozheEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
