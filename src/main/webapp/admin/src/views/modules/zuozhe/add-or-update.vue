               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="作者姓名" prop="zuozheName">
                       <el-input v-model="ruleForm.zuozheName"
                                 placeholder="作者姓名" clearable  :readonly="ro.zuozheName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="作者手机号" prop="zuozhePhone">
                       <el-input v-model="ruleForm.zuozhePhone"
                                 placeholder="作者手机号" clearable  :readonly="ro.zuozhePhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="zuozheEmail">
                       <el-input v-model="ruleForm.zuozheEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.zuozheEmail"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zuozhePhone: [
                              {  required: true, message: '作者手机号不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zuozhe/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zuozheCrossAddOrUpdateFlag = false;
                                        this.parent.search();
