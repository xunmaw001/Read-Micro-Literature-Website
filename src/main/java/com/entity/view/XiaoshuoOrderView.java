...
public class XiaoshuoOrderView extends XiaoshuoOrderEntity implements Serializable {
	...
	public XiaoshuoOrderView() {

	}

	public XiaoshuoOrderView(XiaoshuoOrderEntity xiaoshuoOrderEntity) {
		try {
			BeanUtils.copyProperties(this, xiaoshuoOrderEntity);
