...
public class XiaoshuoCollectionView extends XiaoshuoCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String xiaoshuoCollectionValue;
	...
	public XiaoshuoCollectionView() {

	}

	public XiaoshuoCollectionView(XiaoshuoCollectionEntity xiaoshuoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xiaoshuoCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getXiaoshuoCollectionValue() {
				return xiaoshuoCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setXiaoshuoCollectionValue(String xiaoshuoCollectionValue) {
				this.xiaoshuoCollectionValue = xiaoshuoCollectionValue;
			}
