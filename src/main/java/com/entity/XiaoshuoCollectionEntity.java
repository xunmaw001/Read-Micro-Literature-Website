...
public class XiaoshuoCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XiaoshuoCollectionEntity() {

	}

	public XiaoshuoCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "xiaoshuo_collection_types")
    ...
    public String toString() {
        return "XiaoshuoCollection{" +
            "id=" + id +
            ", xiaoshuoId=" + xiaoshuoId +
            ", yonghuId=" + yonghuId +
            ", xiaoshuoCollectionTypes=" + xiaoshuoCollectionTypes +
