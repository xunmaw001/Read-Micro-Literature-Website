...
public class XiaoshuoOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XiaoshuoOrderEntity() {

	}

	public XiaoshuoOrderEntity(T t) {
		try {
    ...
    public String toString() {
        return "XiaoshuoOrder{" +
            "id=" + id +
            ", xiaoshuoOrderUuidNumber=" + xiaoshuoOrderUuidNumber +
