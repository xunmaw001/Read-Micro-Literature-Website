...
public class XiaoshuoLiuyanEntity<T> implements Serializable {
     ...
     * 留言内容
     */
    @TableField(value = "xiaoshuo_liuyan_text")

    private String xiaoshuoLiuyanText;
	 ...
	 * 设置：留言内容
	 */
    public String getXiaoshuoLiuyanText() {
        return xiaoshuoLiuyanText;
    }
    ...
    public void setXiaoshuoLiuyanText(String xiaoshuoLiuyanText) {
        this.xiaoshuoLiuyanText = xiaoshuoLiuyanText;
    }
    /**
	 * 设置：留言时间
	 */
    ...
    public String toString() {
        return "XiaoshuoLiuyan{" +
            ...
            ", yonghuId=" + yonghuId +
            ", xiaoshuoLiuyanText=" + xiaoshuoLiuyanText +
