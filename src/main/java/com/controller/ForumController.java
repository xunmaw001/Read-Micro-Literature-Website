    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                ZuozheEntity zuozhe = zuozheService.selectById(forum.getZuozheId());
                if(zuozhe != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setZuozheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("zuozhe_id", forum.getZuozheId())
...
//                            forumEntity.setZuozheId(Integer.valueOf(data.get(0)));   //作者 要改的
